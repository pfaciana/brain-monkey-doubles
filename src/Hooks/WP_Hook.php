 ...
 *
 * Mirrors WordPress core WP_Hook class behavior.
 * Handles callback registration, priority sorting, and execution.
 */
...
class WP_Hook implements Iterator, ArrayAccess
{
	...
	public static function build_unique_id ( $hook_name, $callback, $priority ): ?string
	{
	...
	public function add_filter ( $hook_name, $callback, $priority, $accepted_args )
	{
		...
		$idx = self::build_unique_id( $hook_name, $callback, $priority );
	...
	public function remove_filter ( $hook_name, $callback, $priority )
	{
		...
		$function_key = self::build_unique_id( $hook_name, $callback, $priority );
	...
	public function has_filter ( $hook_name = '', $callback = FALSE, $priority = FALSE )
	{
		...
		$function_key = self::build_unique_id( $hook_name, $callback, FALSE );
